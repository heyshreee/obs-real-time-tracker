...
export default function Billing() {
    ...
    const totalViewsUsed = stats?.totalViews || 0;
    ...
    return (
        <div>
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 mb-8">
                ...
                <p className="text-xs text-slate-500 mb-6">Resets at the end of the month</p>
                ...
                <table className="w-full text-left text-sm text-slate-400">
                    ...
                    <tbody className="divide-y divide-slate-800 bg-slate-900/50">
                        <tr>
                            ...
                            <td className="px-6 py-4 text-blue-400 font-bold">1,000,000</td>
                        </tr>
                        <tr>
