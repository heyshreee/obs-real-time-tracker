...
export default function Notifications() {
    ...
    const clearAll = async () => {
        ...
        try {
            ...
            // In a real app, you should add a DELETE /notifications/all endpoint
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {(isOpen || notificationSpotlight) && (
                <div
                    className="fixed inset-0 bg-slate-950/60 backdrop-blur-md z-40 transition-all duration-500 animate-in fade-in"
            ...
            <button
                ...
                className={`relative p-2 rounded-full transition-all duration-200 z-50
                    ...
                    ${notificationSpotlight ? 'bg-slate-800 text-white ring-2 ring-blue-500 ring-offset-2 ring-offset-slate-950 animate-pulse' : ''}
                `}
            >
            ...
            {isOpen && (
                <div className="absolute right-0 top-full mt-4 w-[400px] bg-[#0F172A] border border-slate-800 rounded-2xl shadow-2xl z-50 overflow-hidden ring-1 ring-white/10 animate-in fade-in slide-in-from-top-2 duration-300 ease-out">
                    {/* Header */}
